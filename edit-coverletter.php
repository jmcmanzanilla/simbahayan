...
$d = $_GET['d'];
$permission = "SELECT * FROM proj_proposal WHERE proposal_id = $d";
$sqlper = mysqli_query($link, $permission);
  ...
  <ul class="nav navbar-nav navbar-right" style = "margin-top: 30px;">
    ...
    <div class = "container">
        ...
        <div class  = "col-md-12"><label class = "control-label">ISO Number<sub>(ex. UST:A005-02-LE7)</sub></label>
           <input maxlength="100" name = "iso" type="text" pattern="\w{3}\:\w{4}\-\w{2}\-\w{3,4}" style = "margin-top: 10px;" class="form-control" value = "<?php echo $iso; ?>"/>
        </div>
        
        <div class  = "col-md-12"><label class = "control-label">Academic Year (i.e. AY 2015-2016)</label>
           <input maxlength="100" name = "year" type="text" style = "margin-top: 10px;" required="required" class="form-control" value = "<?php echo $year; ?>"/>
        </div>
        
        <div class = "col-md-12"><label class = "control-label" style = "margin-top: 10px;">Date of Letter</label>
           <input maxlength="100" name = "date" type="text" style = "margin-top: 10px;" required="required" class="form-control" value = "<?php echo $date; ?>"/>
        </div>
        
        
        <div class = "col-md-12"><label class = "control-label" style = "margin-top: 10px;">Person to Address</label>
           <input maxlength="100" name = "address_name" type="text" style = "margin-top: 10px;" required="required" class="form-control" value = "<?php echo $address_name; ?>"/>
        </div>
        
        
        <div class  = "col-md-12"><label class = "control-label" style = "margin-top: 10px;">Position</label>
           <input maxlength="100" name = "address_position" type="text" style = "margin-top: 10px;" required="required" class="form-control" value = "<?php echo $address_position; ?>"/>
        </div>
        
        
        <div class = "col-md-12"><label class = "control-label" style = "margin-top: 10px;">Company Line 1</label>
           <input maxlength="100" name = "address_company1" type="text" style = "margin-top: 10px;" required="required" class="form-control" value = "<?php echo $address_company1; ?>" />
        </div>

        <div class = "col-md-12"><label class = "control-label" style = "margin-top: 10px;">Company Line 2</label>
           <input maxlength="100" name = "address_company2" type="text" style = "margin-top: 10px;" required="required" class="form-control" value = "<?php echo $address_company2; ?>"/>
        </div>
        
        <div class = "col-md-12"><label class = "control-label" style = "margin-top: 10px;">Salutation/Greeting</label>
          <input type = "text" name = "salutation" class = "form-control" style = "margin-top: 10px;" value = "<?php echo $salutation; ?>"/>
        </div>
        ...
        <div class = "col-md-12"><label class = "control-label" style = "margin-top: 10px;" >Closing (i.e. Sincerely Yours)</label>
          <input maxlength="100" name = "closing" type="text" style = "margin-top: 10px;" required="required" class="form-control" value = "<?php echo $closing; ?>"/>
        </div>

        <div class = "col-md-12"><label class = "control-label" style = "margin-top: 10px;">Project Head 1</label>
          <input maxlength="100" name = "proj_head1" type="text" style = "margin-top: 10px;" required="required" class="form-control" value="<?php echo $proj_head1;?>"/>
        </div>

        <div class = "col-md-12"><label class = "control-label" style = "margin-top: 10px;">Position</label>
          <input maxlength="100" name = "position1" type="text" style = "margin-top: 10px;" required="required" class="form-control" value="<?php echo $position1;?>" />
        </div>

        <div class = "col-md-12"><label class = "control-label" style = "margin-top: 10px;">Project Title</label>
          <input maxlength="100" name = "title" type="text" style = "margin-top: 10px;" required="required" class="form-control" value="<?php echo $title;?>"/>
        </div>
