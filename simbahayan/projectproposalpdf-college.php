...
$count = "SELECT COUNT(*) FROM order_signatory WHERE org_num = $lead_org";
$resultcount = mysqli_query($link, $count);
if ($resultcount = 4){
...
$pdf->Ln(5);
$pdf->SetFont('Arial','B',9);
$pdf->Cell(260,5,'1. Personnel (please add or delete sub-items and corresponding rows when necessary)','RBL',0,'L',0);
$pdf->Ln(5);
$pdf->SetFont('Arial','',8);
...
$pdf->Ln(5);
$pdf->Cell(82,5,'Accommodation','LTBR',0,'R',0);
