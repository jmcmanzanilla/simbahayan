...
// Previous
if ($page > 1){
$paginate.= "<li><a href='org-log.php?page=$prev'>Previous</a></li>";
}else{
...
$paginate.= "<li><a href='org-log.php?page=$counter'>$counter</a></li>";}
}
}
...
$paginate.= "...";
$paginate.= "<li><a href='org-log.php?page=$LastPagem1'>$LastPagem1</a></li>";
$paginate.= "<li><a href='org-log.php?page=$lastpage'>$lastpage</a></li>";
}
// Middle hide some front and some back
elseif($lastpage - ($stages * 2) > $page && $page > ($stages * 2))
{
$paginate.= "<li><a href='org-log.php?page=1'>1</a></li>";
$paginate.= "<li><a href='org-log.php?page=2'>2</a></li>";
$paginate.= "...";
...
// Next
if ($page < $counter - 1){
$paginate.= "<li><a href='org-log.php?page=$next'>Next</a></li>";
}else{
