...
while($row = mysqli_fetch_array($results)) {
  $profile = $row['profile'];
  if ($profile ==0) {
  echo "<script type='text/javascript'>alert('You are a new user. Start by creating your profile!');window.location = 'org-newprofile.php';</script>";
  }
  }
?>
<!DOCTYPE html>
...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  <ul class="nav navbar-nav" style = "margin-left: 120px; margin-top: 30px;"> <!--border: 1px solid #000000"-->
...
<div class = "panel panel-body">
  <div class = "col-md-12">
  <p style = "text-align: center; font-size: 30px;">UST SIMBAHAYAN COMMUNITY DEVELOPMENT OFFICE PROPOSAL TRACKING SYSTEM!</p>
  </div>
<div class = "col-md-12">
          <div class = "col-md-1">
          </div>
          <div class = "col-md-2">
            <div class = "col-md-12">
              ...
              <a href = "proj-proposal.php" style = "color: #fff; text-decoration: none;"><div class = "home"><span class="glyphicon glyphicon-pencil" style = "font-size: 30px; margin-left: 35%; margin-top: 30%;" aria-hidden="true"></span><center><p style = "font-size: 11px; color: #000; margin-top: 20px;">ADD PROPOSAL</p></center><span class="text-content"><span>Submit a Community Development proposal</span></span></div></a>
            </div>
            
          </div>
          <div class = "col-md-2">
            <div class = "col-md-12" tooltip = "PROPOSALS">
              <a href = "org-listproposal.php?page=1" style = "color: #fff; text-decoration: none;"><div class = "home"><span class="glyphicon glyphicon-folder-open" style = "font-size: 30px; margin-left: 35%; margin-top: 30%;" aria-hidden="true"></span><center><p style = "font-size: 11px; color: #000; margin-top: 20px;">PROPOSALS</p></center><span class="text-content"><span>See list of submitted proposals and their statuses</span></span></div></a>
            </div>
          </div>
           <div class = "col-md-2">
            <div class = "col-md-12" tooltip = "NOTIFICATIONS">
              <a href = "org-profile.php" style = "color: #fff; text-decoration: none;"><div class = "home"><span class="glyphicon glyphicon-user" style = "font-size: 30px; margin-left: 35%; margin-top: 30%;" aria-hidden="true"></span><center><p style = "font-size: 11px; color: #000; margin-top: 20px;">PROFILE</p></center><span class="text-content"><span>View user profile</span></span></div></a>
            </div>
          </div>
          <div class = "col-md-2">
            <div class = "col-md-12" tooltip = "ANNOUNCEMENTS">
              <a href = "org-announcement.php" style = "color: #fff; text-decoration: none;"><div class = "home"><span class="glyphicon glyphicon-bullhorn" style = "font-size: 30px; margin-left: 35%; margin-top: 30%;" aria-hidden="true"></span><center><p style = "font-size: 11px; color: #000; margin-top: 20px;">ANNOUNCEMENTS</p></center><span class="text-content"><span>See official announcements from UST SCDO</span></span></div></a>
            </div>
          </div>
          <div class = "col-md-2">
            <div class = "col-md-12" tooltip = "RECENT ACTIVITIES">
              <a href = "org-log.php?page=1" style = "color: #fff; text-decoration: none;"><div class = "home"><span class="glyphicon glyphicon-list-alt" style = "font-size: 30px; margin-left: 35%; margin-top: 30%;" aria-hidden="true"></span><center><p style = "font-size: 11px; color: #000; margin-top: 20px;">RECENT ACTIVITIES</p></center><span class="text-content"><span>Keep track of your activities within the system</span></span></div></a>
            </div>
          </div>
          <div class = "col-md-1">
          </div>
