...
<li><a href="changepassword-admin.php">Change Password</a></li>
 ...
 <?php
 echo "<div class ='col-md-2' style ='margin-top: 20px;'><button class='btn btn-default btn-md btn-block signin' style = 'color: #fff; background-color: #05B2d2; border-radius: 0;'><a href ='admin-editprofile.php?d=$d' style = 'color: #fff;'>EDIT PROFILE</a></button></div>
  </div>";
?>
                </div>
