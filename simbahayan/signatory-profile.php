...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  ...
  <ul class="nav navbar-nav navbar-right" style = "margin-top: 30px;">
    ...
    <div class = "col-md-12">
		<table class = "table-condensed" style = "font-size: 16px;">
      	<?php
					$id = $_SESSION['user_id'];
					$sql="SELECT * FROM signatory_profile WHERE user_id ='$id'";
 ...
 <?php
 echo "<div class ='col-md-2' style ='margin-top: 20px;'><button class='btn btn-default btn-md btn-block signin' style = 'color: #fff; background-color: #05B2d2; border-radius: 0;'><a href ='signatory-editprofile.php?d=$d' style = 'color: #fff;'>EDIT PROFILE</a></button></div>
  </div>";
?>
                </div>
