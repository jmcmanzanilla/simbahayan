...
if(isset($_POST['submitted'])){
	...
	$sqlinsert = "INSERT INTO order_signatory (order_number, signatory_num, signatory_name, reference, simbahayan, univ_wide, standard, nstp) VALUES ('$order_number','$signatory_num','$signatory_name','$id', '1', '$univwide','1')";
