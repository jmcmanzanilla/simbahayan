 ...
 <!--  <ul class="nav navbar-nav" style = "margin-left: 120px; margin-top: 30px;">
  ...
  <ul class="nav navbar-nav navbar-right" style = "margin-top: 30px;">
    ...
    <div class = "container">
		...
		<form class = "form-group" action = "answervalidate-signatory.php" method = "post" enctype="multipart/form-data">
              ...
              <p><?php 
                    ...
                    if (isset($_POST['username'])){
                      ...
                      $secquery = "SELECT * FROM signatory_profile WHERE user_id = '".$user_id."'";
