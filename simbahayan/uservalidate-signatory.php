...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  ...
  <ul class="nav navbar-nav navbar-right" style = "margin-top: 30px;">
    ...
    <div class = "container">
		...
		<form class = "form-group" action = "forgotpassword-signatory.php" method = "post" enctype="multipart/form-data">
               <input type="hidden" name="submitted" value="true"/>
              <center><label>Please enter your username:</label></center><br>
              <input type = "text" class = "form-control" name = "username" required>
              <div class = "col-md-3"></div>
              <div class = "col-md-6" style = "margin-top: 15px;"><button class="btn btn-default btn-md btn-block signin" style = "color: #fff; background-color: #23cf5f;" type = "submit">SUBMIT</button></div>
               <div class = "col-md-3"></div>
            </form>    
