...
if(isset($_POST['submit'])){
	...
	$sqlinsert = "INSERT INTO login_user (username, name, account_type, college, password, email, reference) VALUES ('$username', '$name', '$account_type', '$college', md5('$college'), '$email', '$id')";
	$arr_username=array();
    ...
    <div class = "container" style = "height: auto;">
            ...
            <div class = "col-md-12">
                ...
                <div class = "panel panel-body" style = "width: 100%; border-radius: 0;height: auto; background-color: #fff; box-shadow: 5px 5px 5px grey;">
                  ...
                  <div class = "col-md-6">
                <div class = "col-md-12">
                <form role="form" class="form-horizontal" action = "upload-csv.php" method = "post" enctype="multipart/form-data">
...
<div class = "col-md-12">
	<form role="form" class="form-horizontal" action = "add-user1.php" method = "post" enctype="multipart/form-data">
        ...
        <h4 style="margin-top:0px;">ADD SINGLE USER</h4><br>
				...
				<?php
				echo '<label class="control-label">College: </label>';
