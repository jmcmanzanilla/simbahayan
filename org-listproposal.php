...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  <ul class="nav navbar-nav" style = "margin-left: 120px; margin-top: 30px;">
    <li class="active" ><a href="org.php?page=1"><b>WORKSPACE </b><span class="sr-only">(current)</span></a></li>
...
$name = $_SESSION['name'];
                    ...
                    echo "<th>" . $reason1 . "</th>";
					echo "<th>" . $name. "</th>";
                    $program_flow = mysqli_query($link, "SELECT program_flow, vehicle, cover, budget FROM proj_proposal WHERE proposal_id= $proj_id");
					$row = mysqli_fetch_assoc($program_flow);
					$program_flow = $row['program_flow'];
                    $vehicle_request = $row['vehicle'];
                    $cover_letter = $row['cover'];
                    if ($program_flow == 0 || $cover_letter == 0) {
                    
                        echo '<th><div class="dropdown">
                                <button class="dropbtn">Begin to fill up other forms</button>
                           ...
                           /* if ($vehicle_request == 0) {    
                                echo '<a href="vehiclerequest.php?d='.$proj_id.'">Vehicle Request</a>';
                            }*/
                            echo '</div>
                        </div></th>';
                        ...
                        echo '<th><div class="dropdown">
                          ...
                          /*  if ($vehicle_request == 1) {    
                                echo '<a href="edit-vehiclerequest.php?d='.$proj_id.'">Vehicle Request</a>';
                            }*/
                            echo '</div>
                        </div></th>';
                        
                    }
					else if ($program_flow == 1 && $cover_letter == 1) {
