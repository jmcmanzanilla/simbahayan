...
if(isset($_POST['submitted'])){
  ...
  $sqlinsert = "INSERT INTO cover_letter (proposal_id, iso, year, date, address_name, address_position, address_company1, address_company2, salutation, body, closing, proj_head1, position1, title) VALUES ('$d','$iso', '$year', '$date', '$address_name', '$address_position', '$address_company1', '$address_company2', '$salutation', '$body', '$closing', '$proj_head1', '$position1','$title')";
  ...
  if(!mysqli_query($link, $sqlinsert)){
    ...
    echo "<script type='text/javascript'>alert('SUCCESSFULLY ADDED COVER LETTER'); window.location ='org-listproposal.php?d=$d&&days=0';</script>";
}
?>
