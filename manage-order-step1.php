...
while($row = mysqli_fetch_array($results)) {
	...
	echo "<script type='text/javascript'>alert('You do not have permission to manage signatories.');window.location = 'signatory.php';</script>";
	}
	}
    ...
    <div class = "container">
            ...
            <div class = "col-md-12">
                ...
                <div class = "panel panel-body" style = "width: 100%; border-radius: 0;height: auto; color: #000; background-color: #fff; box-shadow: 5px 5px 5px grey;">
                  <div class = "panel panel-heading" style = "font-size: 20px; color: #222; font-weight: bold;"><center>ORGANIZATIONS</center></div>
