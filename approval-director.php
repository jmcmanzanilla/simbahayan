...
if(!isset($_SESSION['name'])){
  ...
  if(isset($_POST['submitted'])){
    ...
    $approve_director = $_POST['approve_director'];
    $finalbudget = $_POST['finalbudget'];
    $finalbudget_code = $_POST['finalbudget_code'];
    


      $sqlupdate= "UPDATE approval_form SET comments3 = '$comments3', approve_director = '$approve_director', finalbudget = '$finalbudget', finalbudget_code = '$finalbudget_code' WHERE proposal_id = $d";
    ...
    <div class = "container">
            ...
            <div class = "col-md-12">
                ...
                <div class = "panel panel-body" style = "width: 100%; border-radius: 0;height: auto; color: #000; background-color: #fff; box-shadow: 5px 5px 5px grey;">
                 ...
                 <form role="form" class="col-md-12" action = "approval-director.php?d=<?php echo $d;?>" method = "post" enctype="multipart/form-data">
        ...
        <div class  = "col-md-12"><label class = "control-label">Project Title</label>
           <input maxlength="100" name = "title" type="text" style = "margin-top: 10px;"disabled class="form-control" value = "<?php echo $title; ?>"/>
        </div>

        
        <div class  = "col-md-6"><label class = "control-label" style = "margin-top: 10px;">Proponent</label>
           <input maxlength="100" name = "proponent" type="text" style = "margin-top: 10px;" disabled class="form-control" value = "<?php echo $proponent; ?>"/>
        </div>
        
        <div class = "col-md-6"><label class = "control-label" style = "margin-top: 10px;">Affiliation</label>
           <select class="form-control" name = "affiliation" style = "margin-top: 10px;" value = "<?php echo $affiliation; ?>" disabled>
        ...
        <div class = "col-md-12"><label class = "control-label" style = "margin-top: 10px;">Program Area</label>
           <input maxlength="100" name = "prog_area" type="text" style = "margin-top: 10px;"disabled  value = "<?php echo $prog_area; ?>" class="form-control" />
        </div>
        
        
        <div class  = "col-md-12"><label class = "control-label" style = "margin-top: 10px;">Target Community(ies) or Institution(s)</label>
           <input maxlength="100" name = "community" type="text" style = "margin-top: 10px;" disabled value = "<?php echo $community; ?>" class="form-control" />
        </div>
        <div class  = "col-md-6"><label class = "control-label" style = "margin-top: 10px;">Date(s) of Implementation</label>
           <input maxlength="100" name = "date" type="text" style = "margin-top: 10px;" disabled value = "<?php echo $date; ?>" class="form-control" />
        </div>
        
        <div class = "col-md-6"><label class = "control-label" style = "margin-top: 10px;">Proposed CSF Budget</label>
           <input maxlength="100" name = "budget" type="text" style = "margin-top: 10px;" disabled value = "<?php echo $budget; ?>" class="form-control" />
        </div>
      </div>
    </div>
      ...
      <div class = "col-md-12"><label class = "control-label" style = "margin-top: 5px;">Comments</label>
        ...
        <input type ="checkbox" name = "reviewed" value = "Yes" disabled<?php if($reviewed === 'Yes') echo 'checked="checked"';?>><i style = "margin-left: 15px;" >I have thoroughly reviewed the community development project/research proposal stated above; hence, I hereby endorse it for processing.</i>
      </div>

      <div class = "col-md-12" style = "margin-top: 20px;">
      <label class = "control-label"> The assigned budget code is:</label><input disabled value = "<?php echo $budget_code; ?>" name = "budget_code" type="text" style = "margin-left: 10px;" class="form-control" />
            </div>
          </div>
        </div>
     ...
     <div class = "panel panel-body" style = "width: 100%; border-radius: 0;height: auto; color: #000; background-color: #fff; box-shadow: 5px 5px 5px grey;">
      ...
      <div class = "col-md-12"><label class = "control-label" style = "margin-top: 5px;">Comments</label>
          <textarea name = "comments2" class = "form-control" style ="height: 100px; margin-top: 10px;" disabled><?php echo $comments2; ?></textarea>
        </div>
        ...
        <div class="form-group col-md-12" style = "margin-top: 10px;">  
            <p style = "margin-left: 15px;"><input type ="radio" name = "recommend_progarea" disabled value = "Recommended" <?php if($recommend_progarea === 'Recommended') echo 'checked="checked"';?>> I hereby recommend for approval the abovementioned community development project/research proposal. </p> 
            <p style = "margin-left: 15px;"><input type ="radio" name = "recommend_progarea" disabled value = "Not Recommended" <?php if($recommend_progarea === 'Not Recommended') echo 'checked="checked"';?>>  I do not recommend for approval the stated community development project/research proposal above. </p>
          </div>

        <div class = "col-md-12" style = "margin-top: 20px;">
      <label class = "control-label"> Budget to be approved:</label><input name = "budget_tobe" disabled value = "<?php echo $budget_tobe; ?>" type="text" style = "margin-left: 10px;" class="form-control" />
            </div>
     ...
     <div class = "panel panel-body" style = "width: 100%; border-radius: 0;height: auto; color: #000; background-color: #fff; box-shadow: 5px 5px 5px grey;">
                  <div class = "panel panel-heading" style = "font-size: 20px; color: #222; font-weight: bold;"><center>Approval from the Director</center></div>
                  <div class = "col-md-12" style = "margin-top: 30px; font-size: 16px;">

      <div class = "col-md-12"><label class = "control-label" style = "margin-top: 5px;">Comments</label>
          <textarea name = "comments3" class = "form-control" style ="height: 100px; margin-top: 10px;"></textarea>
        </div>

        <div class = "col-md-12" style = "margin-top: 20px;"><i style = "font-size: 14;">Please choose the statement of your choice:</i></div>

        <div class="form-group col-md-12" style = "margin-top: 10px;">  
            <p style = "margin-left: 15px;"><input type ="radio" name = "approve_director" value = "Yes" required="required"> I hereby approve the abovementioned community development project/research proposal. </p> 
            <p style = "margin-left: 15px;"><input type ="radio" name = "approve_director" value = "No" required="required">  I hereby disapprove the abovementioned community development project/research proposal. </p>
          </div>

        <div class = "col-md-6" style = "margin-top: 20px;">
      <label class = "control-label"> Approved Budget</label><input name = "finalbudget" type="text" style = "margin-left: 10px;" class="form-control" required="required"/>
            </div>
            <div class = "col-md-6" style = "margin-top: 20px;">
