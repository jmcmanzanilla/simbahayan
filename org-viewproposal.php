...
$d = $_GET['d'];
$sqledit="SELECT edit, days FROM proj_proposal where proposal_id = '".$d."'";
    ...
    <div class = "container">
            ...
            <div class = "col-md-12">
                ...
                <div class = "panel panel-body" style = "width: 100%; border-radius: 0; height: 500px; background-color: #fff; box-shadow: 5px 5px 5px grey;">
                  <div class = "panel panel-heading" style = "font-size: 20px; color: #222; font-weight: bold;">PROPOSAL DETAILS 
                  <?php
                  if ($edit == 1) {
                    
                        echo '<div class="btn-group">
							     
                                <button type= "button" class="btn btn-primary" style = "margin-left: 750px; margin-top = 20px;" Background-color: #4CAF50">Edit</button></style>
    ...
    $affiliation = $row['affiliation'];
                ...
                <div class = "col-md-4">
                  <div class = "col-md-12">';
					...
					else if ($affiliation == "None - NSTP"){
                    echo '<a href = "projectproposalpdf-nstp.php?d='.$d.'&&days='.$days.'" style = "color: #fab303;" class = "btn btn-default btn-md btn-block col-md-12">PROJECT PROPOSAL (PDF)</a>';
                    }
                    ...
                    echo '<a href ="add-terminal.php?d='.$d.'&&days='.$days.'" style = "color: #fab303;" class = "btn btn-default btn-md btn-block col-md-12">TERMINAL REPORT</a>';
                    }
