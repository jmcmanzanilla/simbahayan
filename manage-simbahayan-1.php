    ...
    <div class = "container">
            ...
            <div class = "col-md-12">
                ...
                <div class = "panel panel-body" style = "width: 100%; border-radius: 0;height: auto; color: #000; background-color: #fff; box-shadow: 5px 5px 5px grey;">
                  <div class = "panel panel-heading" style = "font-size: 20px; color: #000; font-weight: bold;"><center>ORGANIZATIONS</center></div>

                  <div class = "col-md-12" style = "margin-top: 30px; font-size: 16px;">

                 <table class = "table table-hover">
				 <tr><a href = 'manage-simbahayan.php'>Standard</a></tr>
				 <?php
