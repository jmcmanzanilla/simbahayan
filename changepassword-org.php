...
if (isset($_POST['submitted'])){
	...
	echo "<script type='text/javascript'>alert('SUCCESSFULLY CHANGED PASSWORD!'); window.location = 'changepassword-org.php';</script>";
			}
...
<ul class="nav navbar-nav" style = "margin-left: 120px; margin-top: 30px;">
  ...
  <ul class="nav navbar-nav navbar-right" style = "margin-top: 30px;">
    ...
    <div class = "container">
		...
		<form class = "form-group" action = "changepassword-org.php" method = "post" enctype="multipart/form-data">
