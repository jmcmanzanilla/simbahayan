  ...
  <div class = "col-md-12">
          ...
          <div class = "col-md-2">
            <div class = "col-md-12">
              ...
              <a href = "add-user1.php" style = "color: #fff; text-decoration: none;"><div class = "home"><span class="glyphicon glyphicon-user" style = "font-size: 30px; margin-left: 35%; margin-top: 30%;" aria-hidden="true"></span><center><p style = "font-size: 11px; color: #000; margin-top: 20px;">ADD USER</p></center><span class="text-content"><span>Add coordinators to the system</span></span></div></a>
            </div>
          </div>
          <div class = "col-md-2">
            <div class = "col-md-12">
              <a href = "manage-simbahayan-1.php" style = "color: #fff; text-decoration: none;"><div class = "home"><span class="glyphicon glyphicon-ok" style = "font-size: 30px; margin-left: 35%; margin-top: 30%;" aria-hidden="true"></span><center><p style = "font-size: 11px; color: #000; margin-top: 5px;">MANAGE SIGNATORIES</p></center><span class="text-content"><span>Set the order of signatories in UST SCDO</span></span></div></a>
            </div>
          </div>
          <div class = "col-md-2">
            <div class = "col-md-12">
              <a href = "add-announcement.php" style = "color: #fff; text-decoration: none;"><div class = "home"><span class="glyphicon glyphicon-bullhorn" style = "font-size: 30px; margin-left: 35%; margin-top: 30%;" aria-hidden="true"></span><center><p style = "font-size: 11px; color: #000; margin-top: 5px;">ADD ANNOUNCEMENT</p></center><span class="text-content"><span>Add announcement for all users</span></span></div></a>
            </div>
          </div>
          <div class = "col-md-2">
            <div class = "col-md-12">
              <a href = "admin-log.php?page=1" style = "color: #fff; text-decoration: none;"><div class = "home"><span class="glyphicon glyphicon-list-alt" style = "font-size: 30px; margin-left: 35%; margin-top: 30%;" aria-hidden="true"></span><center><p style = "font-size: 11px; color: #000; margin-top: 20px;">AUDIT TRAIL</p></center><span class="text-content"><span>Keep track of the activities of all users</span></span></div></a>
            </div>
          </div>
          <div class = "col-md-2">
            <div class = "col-md-12">
