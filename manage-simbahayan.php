...
if(isset($_POST['submitted'])){
	...
	$query = "SELECT * FROM order_signatory WHERE univ_wide = '". $univwide."' AND standard = 1 AND simbahayan = 1";  
	...
	$sqlinsert = "INSERT INTO order_signatory (order_number, signatory_num, signatory_name, reference, simbahayan, univ_wide, standard) VALUES ('$order_number','$signatory_num','$signatory_name','$id', '1', '$univwide','1')";
	if(!mysqli_query($link, $sqlinsert)){
		die("FAILED SUBMISSION");
	}
	echo "<script type='text/javascript'>alert('SUCCESSFULLY ADDED ACCOUNT'); window.location = 'manage-simbahayan.php';</script>";
}
}
?>
...
<li><a href="changepassword-admin.php">Change Password</a></li>
    ...
    <div class = "container">
            ...
            <div class = "col-md-12">
                ...
                <form role="form" class="col-md-5" action = "manage-simbahayan.php" method = "post" enctype="multipart/form-data">
                <input type="hidden" name="submitted" value="true"/>
        <h3 style="margin-top:0px;">CREATE SIGNATORY ORDER </h3><br>
		<div class="form-group col-md-12">
		<label class="control-label">Type of Organization: </label><br>
		<input type="radio" name="univwide" value="0" required> College Based Organizations<br>
		<input type="radio" name="univwide" value="1" required>University Wide Organizations<br>
		</div>
                <div class="col-md-7">
                    <label class="control-label">Position of Signatory: </label>
					<input type="hidden" name="order_number[0]" value="1"/>
					<h5> Program Area Coordinator</h5>
        ...
        <tbody>';
				...
				$sql="SELECT * FROM order_signatory WHERE simbahayan = '1' AND univ_wide = '1' order by order_number asc";
				$result = mysqli_query($link,$sql);
        ...
        <tbody>';
				...
				$sql="SELECT * FROM order_signatory WHERE simbahayan = '1' AND univ_wide = '0' order by order_number asc";
				$result = mysqli_query($link,$sql);
