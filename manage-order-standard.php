...
if(isset($_POST['submitted'])){
	...
	$query = "SELECT * FROM order_signatory WHERE reference= '". $id."' AND standard = 1";  
	...
	$sqlinsert = "INSERT INTO order_signatory (order_number, signatory_num, signatory_name, standard, reference) VALUES ('$order_number','$signatory_num','$signatory_name', '1', '$id')";
	if(!mysqli_query($link, $sqlinsert)){
		die("FAILED SUBMISSION");
	}
	echo "<script type='text/javascript'>alert('SUCCESSFULLY ADDED ACCOUNT'); window.location = 'manage-order-standard.php';</script>";
}
}
?>
  ...
  <ul class="nav navbar-nav navbar-right" style = "margin-top: 30px;">
    ...
    <div class = "container">
            ...
            <div class = "col-md-12">
                ...
                <form role="form" class="col-md-5" action = "manage-order-standard.php" method = "post" enctype="multipart/form-data">
