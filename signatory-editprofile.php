...
if(isset($_POST['submitted'])){
    ...
    echo "<script type='text/javascript'>alert('SUCCESSFULLY EDITED PROFILE!'); window.location = 'signatory-profile.php';</script>";
}
...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  <ul class="nav navbar-nav" style = "margin-left: 120px; margin-top: 30px;">
    ...
    <li class="active"><a href="signatory-profile.php"><b>PROFILE</b></a></li>
  ...
  <ul class="nav navbar-nav navbar-right" style = "margin-top: 30px;">
    ...
    <div class = "col-md-12">
      <form role="form" autocomplete="off" class="form-horizontal" method="post" action="signatory-editprofile.php" enctype="multipart/form-data">
